...
import 'package:rick_and_morty/character/data/character_repository.dart' as _i9;
...
import 'package:rick_and_morty/character/presentation/bloc/character_bloc.dart'
    as _i12;
import 'package:rick_and_morty/details/data/details_repository.dart' as _i10;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i8.CharacterDioService>(
      () => _i8.CharacterDioServiceImpl(gh<_i3.Dio>()));
  gh.factory<_i9.CharacterRepository>(
      () => _i9.CharacterRepositoryImpl(gh<_i8.CharacterDioService>()));
  gh.factory<_i10.CharacterDetailsRepository>(() =>
      _i10.CharacterDetailsRepositoryImpl(gh<_i7.CharacterDetailsService>()));
  gh.factory<_i11.CharacterInteractor>(
      () => _i11.CharacterInteractorImpl(gh<_i9.CharacterRepository>()));
  gh.factory<_i12.CharacterBloc>(
      () => _i12.CharacterBloc(gh<_i11.CharacterInteractor>()));
  gh.factory<_i13.CharacterDetailsBloc>(
      () => _i13.CharacterDetailsBloc(gh<_i10.CharacterDetailsRepository>()));
  return getIt;
}
